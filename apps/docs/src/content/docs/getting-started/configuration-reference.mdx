...
import yamlConfig from "./config-examples/config_file.yaml?raw";
import jsonConfig from "./config-examples/config_file.json?raw";
import json5Config from "./config-examples/config_file.json5?raw";
...
| `pkce`         |          | Boolean | Additional query parameters to include in authorization requests.                                 |
